...
| Ebyte E280 (SX1280) | `RADIO_EBYTE_E280_SX1280` | COM17, COM18 historical; COM45, COM46 latest | 115200 | `AT+CHAN` | PASS 12/0 per valid rate; loss characterized | Latest power-campaign pair: COM45 measured through PPK2 and COM46 peer. Channel 10/11/12 isolation passed at 1K/100K/2M; channel 21/22 is invalid at 2M. Firmware shadow-state rollback and an inter-run E280 reset corrected the packet anomaly, yielding 180/180 effective packet deliveries. Continuous UART loss is retained in `power_profiler/comparisons/e280/VALIDATION.md`. |
...
| RA-01SH (SX1262) | `RADIO_RA01SH_SX1262` | COM31, COM32 | 9600 | `AT+FREQ` | PASS 18/0 | Latest power-campaign pair; frequency isolation and bidirectional exchange passed. |
...
| RA-02 (SX1278), two-capacitor carrier | `RADIO_RA02_SX1278_2CAP` | COM35, COM36 | 9600 | `AT+FREQ` | PASS 18/0 | Latest power-campaign pair; COM35 measured through PPK2 and COM36 peer. |
...
| nRF24L01 | `RADIO_NRF24L01` | COM41, COM42 | 9600 | `AT+CHAN`, `AT+RATE`, `AT+PWR` | PASS 18/0 per rate; loss characterized | Channel isolation passed at 250/1000/2000 kbps. The sustained two-channel diagnostic reproduces high-power loss at the two slower rates with zero serial errors; see `power_profiler/comparisons/nrf24l01/VALIDATION.md`. |
| nRF24L01+PA | `RADIO_NRF24L01_PA` | COM43, COM44 | 9600 | `AT+CHAN`, `AT+RATE`, `AT+PWR` | PASS 18/0 at 250 kbps low power; loss characterized | Latest power-campaign pair: COM43 measured through PPK2, COM44 peer. Severe power/rate-dependent loss was reproduced in both directions and on two channels; see `power_profiler/comparisons/nrf24l01_pa/VALIDATION.md`. |
...
| RA-08 (ASR6601) | External module-side firmware | COM45, COM46 historical | 115200 | `AT+CHAN` | PASS 102/0 | `Test-Ra08ChannelIsolation_RA08_COM45_COM46_REOPEN_COM45_COM46_20260701_160824.txt`; historical assignment, not currently connected. The dedicated script reopens serial ports between directions because COM46 does not always echo after TX in long sessions. |
