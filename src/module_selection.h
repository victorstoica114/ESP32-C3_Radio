...
#define RADIO_EBYTE_E32_868T30D   3286830
#define RADIO_EBYTE_E32_433T33D   3243333
...
#define BRIDGE               6
  ...
  #endif
#elif RADIO_MODULE == RADIO_EBYTE_E32_868T30D
  #if RADIO_PROGRAM == AT_COMMANDS
    #define E32_DISPLAY_LINE2 "E32T30"
    #define E32_POWER_DBM_CODE0 30
    #define E32_POWER_DBM_CODE1 27
    #define E32_POWER_DBM_CODE2 24
    #define E32_POWER_DBM_CODE3 21
    #include "Ebyte/AT-Commands Ebyte E32.cpp"
  #else
    #error "Selected RADIO_PROGRAM is not available for EBYTE_E32_868T30D. Available: AT_COMMANDS."
  #endif
#elif RADIO_MODULE == RADIO_EBYTE_E32_433T33D
  #if RADIO_PROGRAM == AT_COMMANDS
    #define E32_DISPLAY_LINE2 "E32T33"
    #define E32_POWER_DBM_CODE0 33
    #define E32_POWER_DBM_CODE1 30
    #define E32_POWER_DBM_CODE2 27
    #define E32_POWER_DBM_CODE3 24
    #include "Ebyte/AT-Commands Ebyte E32.cpp"
  #else
    #error "Selected RADIO_PROGRAM is not available for EBYTE_E32_433T33D. Available: AT_COMMANDS."
  #endif
