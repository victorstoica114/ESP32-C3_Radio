...
\begin{axis}[width=12.5cm, height=7.4cm,
  title={nRF24L01: packet loss versus radio rate},
  xmode=log, log basis x=10,
  xmin=166.666667, xmax=3000, xtick={250,1000,2000},
  xticklabels={250,1000,2000}, ymin=0, ymax=55,
...
\addplot+[blue!75!black, solid, mark=*] coordinates {(250,34.7800238) (1000,27.2370266) (2000,0)};
\addlegendentry{0 dBm}
\addplot+[orange!90!black, dashed, mark=square*] coordinates {(250,40.5766944) (1000,21.4245653) (2000,0)};
\addlegendentry{-6 dBm}
\addplot+[green!50!black, dashdotted, mark=triangle*] coordinates {(250,0.0297000297) (1000,0) (2000,0)};
