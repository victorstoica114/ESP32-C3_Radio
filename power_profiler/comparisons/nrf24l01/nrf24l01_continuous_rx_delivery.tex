...
\begin{axis}[width=10.5cm, height=6.4cm,
  title={nRF24L01: cadre recepționate în testul continuu},
...
\addplot+[red!75!black, line width=1.2pt, mark=square*, mark size=2.8pt] coordinates {(-18,100) (-6,78.5754347) (0,72.7629734)};
\end{axis}
\node[font=\footnotesize, align=center, text width=10cm] at (5.25,-1.45)
  {3565--3566 cadre transmise/punct; 32 B/cadru, profil 1000 kbps, 60 s.};
\end{tikzpicture}
\end{document}
