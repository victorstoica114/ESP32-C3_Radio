...
\begin{axis}[width=10.5cm, height=6.4cm,
  title={CC1101 V2: cadre recepționate în testul continuu},
...
\addplot+[red!75!black, line width=1.2pt, mark=square*, mark size=2.8pt] coordinates {(-30,70.7152497) (0,100) (10,100)};
\end{axis}
\node[font=\footnotesize, align=center, text width=10cm] at (5.25,-1.45)
  {2223 cadre transmise la fiecare punct; 32 B/cadru, 38{,}4 kbps, 60 s.};
\end{tikzpicture}
\end{document}
